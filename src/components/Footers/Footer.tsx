...
const Footer = () => {
  ...
  const footerData: footerDataProps[] = [
    {
      ...
      links: [
        ...
        {
          label: firstName ? "Change Password" : "Forgot Password",
  ...
  return (
    <footer className="bg-gray-50 w-full py-2 flex flex-col item-center">
      {/* bg-gray-50 text-gray-600 py-12 px-4 sm:px-6 lg:px-8 */}
      {/* bg-white w-full py-2 flex flex-col item-center border-t-[3px] border-primary */}

      {/* mx-auto max-w-[1400px] w-full hidden slg:block */}
      {/* max-w-7xl mx-auto */}
