        ...
        <div className="hidden slg:grid grid-cols-4 items-center w-full py-1 max-w-[1200px] z-30 px-5 xl:px-0">
          ...
          <div className="flex justify-center h-10 col-span-2">
            <div className="relative max-w-full mx-6">
              {/* <Search className="absolute left-3 top-2.5 text-primary w-5 h-5" /> */}
              <input
                type="text"
              ...
              {isSearchLoading ? (
                ...
                <button
                  ...
                  className="bg-primary px-6 text-primary font-semibold transition-[.5] rounded-r-sm hover:text-primaryColor-200 focus:outline-none focus:ring focus:border-blue-300 text-xl"
                  onClick={handleSearch}
                >
                  <Search className="absolute right-3 top-2.5 text-primary w-5 h-5" />
                </button>
              )}
            </div>
          </div>
          <div className="flex items-center justify-end gap-4 xl:gap-8 col-span-1">
                    ...
                    <AnimatePresence>
                      {isUserClick && (
                        ...
                        >
                          ...
                          <span
                            onClick={() => signOut()}
                            className="text-center pt-1 pb-2 text-gray-400 hover:text-primary border-t"
                          >
                            Log Out
                          </span>
                        </motion.nav>
          ...
          <div className="flex items-center w-full justify-between">
            ...
            <div className="flex gap-4 justify-center items-center cursor-pointer">
              ...
              {typeof window !== "undefined" && (
                <div
                  onClick={() => router.push("/cart")}
                  className="flex relative justify-center items-center rounded-full w-10 h-10 p-2 text-xs"
                >
                  <span className="absolute -top-1 -right-1 w-5 h-5 bg-red-500 text-white shadow-lg flex justify-center items-center rounded-full">
                    {totalItems}
                  </span>
